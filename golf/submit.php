...
try {
  ...
  $message = "<p>Thank you for registering for the 2018 Count On Me Golf Tournament.</p><p>This yearly event is presented by the Fighting Irish Legacy Club and all proceeds will go to support St. Patrick's Fighting Irish Football.</p><p>Your registration details are as follows:</p>";
  if ($isDinnerOnly) {
  ...
  $message .= "<p>We very much appreciate your support and look forward to seeing you on July 14th, 2018 at Huron Oaks!</p>";
  ...
  $subject = "Count On Me Golf Tournament Registration 2018";
